...
<body>
	<form action="<%=path%>/userReg.action" name="form1" method="post">
		<table width="98%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="14" colspan="2 " class="navtitle">&nbsp;用户注册&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">&nbsp; <input type="text"
					name="shenfenzheng" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
				...
				<td bgcolor="#FFFFFF">&nbsp; <input type="text"
					name="zhunkaozheng" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">&nbsp; <input name="ruxueshijian"
			...
			<tr>
				...
				<td width="80%" bgcolor="#FFFFFF">&nbsp; <input type="text"
					name="loginname" id="loginname" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
				...
				<td bgcolor="#FFFFFF">&nbsp; <input type="password"
					name="loginpw" size="21.5" /><font color="red">*</font>
				</td>
			</tr>
			<tr>
