...
<body>
	<c:if test="${sessionScope.userType==0}">
		<div class="part">
			<div class="title title0 index">
				<span><a href="<%=path%>/admin/index/userinfo.jsp" target="mainFrame">修改个人密码</a>
				</span>
			</div>
		</div>
		<div class="line"></div>
		<div class="part">
			...
			<div class="content" style="display: none;">
				<div class="hang">
					<a href="<%=path%>/adminManage.action" target="mainFrame">管理员管理</a>
				</div>
				<div class="hang">
					<a href="<%=path%>/admin/admin/adminAdd.jsp" target="mainFrame">管理员添加</a>
				</div>
			</div>
		</div>
		<div class="line"></div>
		<div class="part">
			...
			<div class="content" style="display: none;">
				<div class="hang">
					<a href="<%=path%>/userMana.action" target="mainFrame">基本信息管理</a>
				</div>
				<div class="hang">
					<a href="<%=path %>/chengjiMana.action" target="mainFrame">数据管理</a>
				</div>
				<div class="hang">
		...
		<div class="part">
			...
			<div class="content" style="display: none;">
				<div class="hang">
					<a href="<%=path%>/gonggaoMana3.action" target="mainFrame">糖尿病管理</a>
				</div>
				<div class="hang">
		...
		<div class="part">
			...
			<div class="content" style="display: none;">
				<div class="hang">
					<a href="<%=path%>/gonggaoMana.action" target="mainFrame">健康教育</a>
				</div>
				<div class="hang">
					<a href="<%=path%>/admin/gonggao/gonggaoAdd.jsp"
						target="mainFrame">健康教育录入</a>
				</div>
			</div>
		</div>
		<div class="line"></div>
		<div class="part">
			<div class="title title6" rel="0">
				<a href="#" onclick="logout()"><span>安全退出系统</span>
				</a>
			</div>
		</div>
	</c:if>
	<c:if test="${sessionScope.userType==2}">
		...
		<div class="part">
			...
			<div class="content" style="display: none;">
				<div class="hang">
					<a href="<%=path %>/admin/user/userinfo.jsp" target="mainFrame">健康档案</a>
				</div>
				<div class="hang">
					<a href="<%=path %>/listJiangli1.action?stuId=${sessionScope.user.id}" target="mainFrame">过往病史</a>
				</div>
				<div class="hang">
					<a href="<%=path %>/admin/jiangli/jiangli_add.jsp" target="mainFrame">添加过往病史</a>
				</div>
			</div>
		</div>
				<div class="line"></div>
