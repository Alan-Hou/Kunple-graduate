	...
	<body>
			<form action="<%=path %>/userEdit.action" name="form1" method="post">
				<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
					<tr bgcolor="#E7E7E7">
						<td height="14" colspan="2 " class="navtitle">&nbsp;健康档案修改&nbsp;</td>
					</tr>
					
								<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">用户编号：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="xuehao"  value="${sessionScope.user.xuehao }"/><font
					color="red">*</font></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">姓名：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="name1"  value="${sessionScope.user.name1 }"/><font
					color="red">*</font></td>
			</tr>
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="shenfenzheng"   value="${sessionScope.user.shenfenzheng }"/><font
					color="red">*</font></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">血糖：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="zhunkaozheng"   value="${sessionScope.user.zhunkaozheng }"/><font
					color="red">*</font></td>
			</tr>	
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">地址：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="xibie"  value="${sessionScope.user.xibie }"/><font
					color="red">*</font></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">电话：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="nianji"  value="${sessionScope.user.nianji }"/><font
					color="red">*</font></td>
			</tr>								
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="age"  value="${sessionScope.user.age}"/></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
			...
			<tr>
				...
				<td width="80%" bgcolor="#FFFFFF">&nbsp; <input type="text"
					name="loginname" id="loginname"   value="${sessionScope.user.loginname }"/><font color="red">*</font></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9"
					style="font-size: 11px;">密 码：</td>
				<td bgcolor="#FFFFFF">&nbsp; <input type="password"
					name="loginpw" size="21.5"   value="${sessionScope.user.loginpw }"/><font color="red">*</font></td>
			</tr>
			<tr>
				<td height="30" align="right" bgcolor="#F9F9F9">
					&nbsp;
