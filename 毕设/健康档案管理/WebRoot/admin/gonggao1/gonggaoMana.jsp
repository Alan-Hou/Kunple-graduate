...
<link href="<%=path%>/css/WdatePicker.css" rel="stylesheet"
	...
	<link href="<%=path%>/css/UserStyle.css" rel="stylesheet"
        ...
        <script language="javascript">
           function gonggaoAdd()
           {
              var url="<%=path %>/admin/gonggao1/gonggaoAdd.jsp";
              window.location.href=url;
           }
           
           function gonggaoDetail(gonggaoId)
           {
                 var url="<%=path %>/gonggaoDetail1.action?gonggaoId="+gonggaoId;
                 var n="";
                 var w="580px";
                 var h="600px";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="5 " class="navtitle">&nbsp;糖尿病信息管理&nbsp;</td>
				</tr>
				<tr align="center" bgcolor="#FAFAF1" height="22">
					<th width="20%">标题</th>
					<th width="20%">发布时间</th>
					<th width="25%">糖尿病类型</th>
					<th width="20%">内容</th>
					<th width="20%">操作</th>
		        </tr>	
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<s:if test="#gonggao.gonggaoOne1 == 'tangniaobing'">糖尿病信息</s:if>
					</td>
					<td bgcolor="#FFFFFF" align="center">
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 5px;">
			  <tr>
			    <td>
			    <c:if test="${sessionScope.userType!=2}">
			      <input type="button" value="添加糖尿病信息" style="width: 100px;" onclick="gonggaoAdd()" />
			      </c:if>
			    </td>
			  </tr>
		    </table>
